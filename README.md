...
- **One socket, many targets** — clone a `Client` across tasks and multiplex
  replies by identifier/sequence.
...
![How surge-ping fans out over a single socket](https://raw.githubusercontent.com/kolapapa/surge-ping/main/assets/architecture.svg)
